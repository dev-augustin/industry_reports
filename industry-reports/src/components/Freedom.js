...
export default function Freedom(props) {
    return (
        ...
        <p id="paragraph-2">
        These calls to action are met with concerns about how private companies can meaningfully determine the boundaries of speech. For example, David Kaye, the UN’s special rapporteur on the right to freedom of opinion and expression, has expressed concern that content moderation systems could, even unintentionally, censor minority opinions and other unpopular yet critical forms of free expression. The NYU’s Center for Business and Human Rights argues for more governance of technology platforms but states that government intervention can also do harm.
        </p>
        </div>
        </div>
        );
